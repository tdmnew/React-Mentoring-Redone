      ...
      <div className="header">
        <div className="header__top">
          <h1 className="header__top logo">
            <span className="header__top logo--left">{title[0]}</span>
            <span className="header__top logo--right">{title[1]}</span>
          </h1>
          {isOpen ? (
            <button
            ...
            <button className="header__top btn" onClick={toggleAddMovieModal}>
