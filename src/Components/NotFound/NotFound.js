...
export default function NotFound() {
    ...
    return (
        <div className="not-found">
            ...
            <h3 className="not-found body__text--top">{t(I18N_KEYS.PAGE_NOT_FOUND)}</h3>
            <h4 className="not-found body__text--bottom">{t(I18N_KEYS.FOUR_OH_FOUR)}</h4>
            <NavLink className="not-found body__btn" to="/">{t(I18N_KEYS.GO_HOME)}</NavLink>
            </div>
        </div>
    )
}
